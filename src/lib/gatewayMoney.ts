...
//
// The invariant, unchanged from the Paystack-only era: the school receives the
// EXACT fee it set. The platform fee and the gateway's charge are both added on
// top and borne by the parent.
//
